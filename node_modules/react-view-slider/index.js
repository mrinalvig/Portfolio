...
function (_React$Component) {
  ...
  function ViewSlider() {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(ViewSlider)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderView", function (index) {
      ...
      var style = (0, _objectSpread2["default"])({}, baseViewStyle, viewStyle);
      ...
      return React.createElement("div", {
        ...
        state: _this.getTransitionState(index)
  ...
  (0, _createClass2["default"])(ViewSlider, [{
    ...
    value: function render() {
      var _this$getDefaultedPro6 = this.getDefaultedProps(),
          ...
          numViews = _this$getDefaultedPro6.numViews,
      ...
      var finalOuterStyle = (0, _objectSpread2["default"])({
      ...
      var finalViewportStyle = (0, _objectSpread2["default"])({
        position: 'relative',
        transform: "translateX(".concat(activeView * spacing * (rtl ? 100 : -100), "%)"),
        whiteSpace: 'nowrap',
        minHeight: '100%',
